<?php
$orderPrice = "";
$idProducer = isset($_GET['id']) ? $_GET['id'] : "";
     ...
     <div class="mid-tcont">
          <div>
               <select name="" id="sort-box" class="sapxep" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                    ...
                    <option value="?id=<?php ".$idProducer." ?>?field=price&sort=asc">Giá tăng dần</option>
                    <option value="?id=<?php ".$idProducer." ?>?field=price&sort=desc">Giá giảm dần</option>
               </select>
          </div>
     </div>
     ...
     <div class="main-content">
          ...
          <div class="main-container">
               ...
               <div class="grid-view view_wrap">
                    <?php
                    $sql = "SELECT * FROM `products` WHERE products.producer_id='$_GET[id]' ORDER BY product_id DESC";
               ...
               <div class="list-view view_wrap">
                    <?php
                    $sql = "SELECT * FROM `products` WHERE products.producer_id='$_GET[id]' " . $orderPrice . "";
                    $productList = executeResult($sql);
